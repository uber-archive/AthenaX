...
import com.uber.athenax.backend.api.impl.InstancesApiServiceImpl;
...
public final class InstancesApiServiceFactory {
  private static final InstancesApiService SERVICE = new InstancesApiServiceImpl(ServerContext.INSTANCE);
